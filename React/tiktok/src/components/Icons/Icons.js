...
export const UploadIcon = ({ width = '2.2rem', height = '2.2rem', classNames }) => (
    <svg
...
export const SearchIcon = (({ width = '1.1rem', height = '1.1rem', classNames }) => (
    <svg
        className={classNames}
        fill="currentColor"
        viewBox="0 0 48 48"
...
export const LiveActiveIcon = ({ width = '2.2rem', height = '2.2rem', className }) => (
    <svg
        className={className}
        class="css-dwsybk-StyledOldLiveIconFill egn9vfa3"
        width={width}
        data-e2e=""
        height={height}
        viewBox="0 0 48 48"
